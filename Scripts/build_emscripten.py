...
if __name__ == "__main__":
    ...
    command_line = "em++ --bind -std=c++17 -I{} -s WASM=0 -O2 -DEMSCRIPTEN -DBOX_DIST -DBOX_PLATFORM_WINDOWS -s EXPORTED_RUNTIME_METHODS=[\"ccall\",\"cwrap\"]"# -s EXPORTED_FUNCTIONS=[".format(SOURCE_DIRECTORY)
